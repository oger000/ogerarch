...
if ($_REQUEST['_action'] == 'loadList' || $_REQUEST['_action'] == 'loadRecord') {
	...
	$sele['fields'] = '*';
	$sele['table'] = ArchObjectType::$tableName;
...
if ($_REQUEST['_action'] == 'save') {
	...
	// create new
	$record = new ArchObjectType($_REQUEST);


	// construct new id for insert
	if ($_REQUEST['dbAction'] == Db::ACTION_INSERT) {
		$record->values['id'] = (string)(ArchObjectType::getMaxValue('id') + 1);
	}
