...
/**
*/
Ext.define('App.view.report.stock.location.PackingListWin', {
	extend: 'Ext.window.Window',
	alias: 'widget.reportstockpackinglistwindow',

	title: Oger._('Ausfolgeschein'),
			...
			items: [
				...
				{ xtype: 'radiogroup', fieldLabel: 'Grabung',
					items: [
						...
						{ boxLabel: 'Alle Grabungen', name: 'excavScope', inputValue: 'all', disabled: true },
					]
				},  // eo radio grp
				...
				{ name: 'printStatusList', xtype: 'checkbox', checked: true,
					inputValue: '1', uncheckedValue: '0',
					boxLabel: Oger._('Bearbeitungsstatus drucken'),
				},
