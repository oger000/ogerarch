...
*/
Ext.define('App.view.master.archObjectType.GridWindow', {
	...
	items: [ { xtype: 'archobjecttypemastergrid' } ],
	...
	'showDetailWindow': function(id) {
		...
		var win = Ext.create('App.view.master.archObjectType.DetailWindow');
