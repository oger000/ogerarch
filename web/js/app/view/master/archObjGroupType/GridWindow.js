...
/**
* Arch object group type detail window
*/
Ext.define('App.view.master.archObjGroupType.GridWindow', {
	extend: 'Ext.window.Window',

	title: Oger._('Objektgruppe Art/Bezeichnung'),
	width: 750,
	height: 500,
	modal: true,
	//autoScroll: true,
	...
	items: [ { xtype: 'archobjgrouptypemastergrid' } ],
	...
	listeners: {
		...
		close: function(cmp, options) {
			...
			if (inputCenterPanel) {
				...
				inputCenterPanel.stratumTypeStore.load();
			}
		},
		*/
	},
	...
	'showDetailWindow': function(id) {
		...
		var win = Ext.create('App.view.master.archObjGroupType.DetailWindow');
