...
{ header
	CELLAT   [ 20,20 ], [], [ ,B,16 ] #Objektgruppe-Liste {excavName}
	NEWLINE
	...
	LINE  [ 20, 45, 190, 45 ]
	CELLAT     [ 20,45 ] [ 15]     [ ,B,10 ]           # Obj.Grp
	CLIPCELL   [ 35, 5, 0, 0]      [ ,B,10 ]           # Bezeichnung
	CLIPCELL   [ 70, 5, 0, 0]      [ ,B,10 ]           # Zugehörige Objekte
...
{ body
	CELL       [ 15, 5, 0, 0, C]   [ ,,10 ]         #{archObjGroupId}
	CLIPCELL   [ 35, 5, 0, 0, C]   [ ,,10 ]         #{typeName}
	MCELL      [ 70,,,,,0 ]  [ ,,10 ]               #{archObjectIdList}
