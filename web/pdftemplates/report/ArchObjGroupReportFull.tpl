...
{ header
	CELLAT   [ 20,20 ], [], [,B,20] #Objektgruppe-Protokoll {excavName}
	NEWLINE
...
{ body
	NEWLINE
	CELL  [ 0,0,1,0,C ] [ ,B,13 ]     #Objektgruppe: {archObjGroupId}
	NEWLINE
	NEWLINE
	CELL    [] [ ,B,10 ]         #Art/Bezeichnung:
	CELLAT  [ 50 ]               #{typeName}
	NEWLINE
	CELL    [] [ ,B,10 ]         #Objektliste:
	MCELL    [ 0,0,0,,,1, 50 ]   #{archObjectIdList}
	//NEWLINE
